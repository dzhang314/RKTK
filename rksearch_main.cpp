...
static inline long long int get_precision(int argc, char **argv) {
    if (argc >= 2) {
        char *end;
        ...
        if (read_whole_arg && is_positive) { return precision; }
    }
    return 53;
}
...
int main(int argc, char **argv) {
    ...
    // const long long int prec = get_precision(argc, argv);
