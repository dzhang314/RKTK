...
namespace rktk {
    ...
    public:
        ...
        T objective_function(const T *x) {
            T *__restrict const m = m_tab.data();
        ...
        T objective_function_partial(const T *x, std::size_t i) {
            T *__restrict const m_re = m_tab.data();
            T *__restrict const m_du = m_tab.data() + table_size;
        ...
        void objective_gradient(T *__restrict g, const T *__restrict x) {
